...
@Configuration
@ConditionalOnClass({it.zeroics.strg.renditions.dicom.AutoConfigure.class})
@Import(it.zeroics.strg.renditions.dicom.AutoConfigure.class)	
public class RenditionsDicomAutoConfiguration {
}
