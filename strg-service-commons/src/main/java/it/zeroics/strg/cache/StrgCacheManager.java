...
public class StrgCacheManager implements org.springframework.cache.CacheManager, BeanClassLoaderAware  {
	 ...
	 */
	public StrgCacheManager(String... cacheNames) {
	...
	protected Cache createConcurrentMapCache(String name) {
		...
		return new it.zeroics.strg.cache.StrgCache(name, new ConcurrentHashMap<>(256),
